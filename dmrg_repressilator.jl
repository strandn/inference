...
function dmrg_repressilator()
    ...
    α2_idx = searchsortedfirst(grid[1], α2_true)
    α3_idx = searchsortedfirst(grid[2], α3_true)
    m_idx = searchsortedfirst(grid[3], m_true)
    η_idx = searchsortedfirst(grid[4], η_true)
